...
function useDraggableBlockMenu(
  ...
  return createPortal(
    <>
      <div
        className={`${DRAGGABLE_BLOCK_MENU_CLASSNAME} opacity-0 rounded-sm absolute will-change-transform left-2 top-0 hover:bg-gray-200 cursor-grab active:cursor-grabbing`}
        ref={menuRef}
        draggable={true}
      ...
      >
        {isEditable && (
          <div className="w-5 h-6 flex justify-center items-center opacity-30 px-0.5">
            <Menu className="pointer-events-none h-5 w-full" />
          </div>
        )}
      </div>
      <div
